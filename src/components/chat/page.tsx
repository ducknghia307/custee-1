      ...
      <div>
        ...
        {isOpen && (
          <div className="fixed bottom-0 right-5 z-50">
            ...
            <div className="flex">
            {role === "admin" && (
                <div className="bg-gray-200 w-36 h-[450px] shadow-lg rounded-lg">
                  <p className="text-lg font-bold p-2">Chat Rooms</p>
                  {conversations.map((conversation, index) => (
                    <div
                      key={index}
                      className={`p-2 border-b cursor-pointer flex items-center ${selectedConversationId === conversation._id ? 'bg-gray-300' : ''}`}
